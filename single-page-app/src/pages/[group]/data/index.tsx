...
import { query, transform } from '@/overrides/readData';
...
const Data: PageWithLayout = () => {
  const modelString = 'data';
  const groupString = 'models';
        ...
        >
          ...
          <TableBody>
            {records.map((record) => {
              ...
              // const fileURL = record.data.fileURL as string | undefined;
